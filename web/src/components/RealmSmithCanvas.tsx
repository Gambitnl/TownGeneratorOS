...
import { TownGenerator } from '../services/realmsmith/RealmSmithGenerator';
import { AssetPainter } from '../services/realmsmith/RealmSmithPainter';
import { TownMap, TownOptions, BiomeType, TownDensity } from '../services/realmsmith/types';
import { RefreshCw, Download, Map as MapIcon, Compass, TreeDeciduous, Home, Sparkles, BookOpen, ZoomIn, ZoomOut, Maximize, Move, Moon, Sun, Grid, FileJson } from 'lucide-react';
...
const TownCanvas: React.FC = () => {
    ...
    const handleExportVTT = () => {
        if (!mapData) return;
        vttExporter.downloadRealmSmithJSON(mapData, `town-${biome.toLowerCase()}-${seed}.vtt.json`);
    };
